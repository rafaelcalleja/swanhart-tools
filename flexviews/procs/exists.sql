...
******
*/
CREATE  FUNCTION `flexviews`.`schema_exists`(v_schema VARCHAR(64) CHARACTER SET UTF8)
    RETURNS BOOLEAN
    NOT DETERMINISTIC
    READS SQL DATA
...
******
*/
CREATE  FUNCTION `flexviews`.`table_exists`(v_schema VARCHAR(64) CHARACTER SET UTF8, v_table VARCHAR(64) CHARACTER SET UTF8)
    RETURNS BOOLEAN
    NOT DETERMINISTIC
    READS SQL DATA
